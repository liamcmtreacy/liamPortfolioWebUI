...
function Navigation($$payload) {
  $$payload.out += `<nav class="svelte-1er3u68"><ul class="svelte-1er3u68"><li class="svelte-1er3u68"><a${attr("href", `${base}/`)} class="svelte-1er3u68">Home Page</a></li> <li class="svelte-1er3u68"><a${attr("href", `${base}/art`)} class="svelte-1er3u68">My Artwork</a></li> <li class="svelte-1er3u68"><a${attr("href", `${base}/games`)} class="svelte-1er3u68">Games I have created</a></li> <li class="svelte-1er3u68"><a${attr("href", `${base}/college`)} class="svelte-1er3u68">My Studies</a></li> <li class="svelte-1er3u68"><a${attr("href", `${base}/Whales`)} class="svelte-1er3u68">The World of Whales</a></li> <li class="svelte-1er3u68"><a${attr("href", `${base}/contact`)} class="svelte-1er3u68">Contact Me</a></li> <li class="svelte-1er3u68"><a${attr("href", `${base}/AboutMe`)} class="svelte-1er3u68">About Me</a></li></ul></nav>`;
}
