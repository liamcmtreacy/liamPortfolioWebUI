...
I hope to obtain a career working in Animation, my ultimate goal would be to have an animated series of my own one day.</p> <p class="svelte-1a2gkgp">I currently work in the Eddie Rockets Diner in Shamrock Plaza, Carlow, I am also a volunteer at Visual Gallery and Theathre in Carlow. My future plan is too enroll in the IADT DL931 Animation Masters once I graduate.</p> <h1 class="svelte-1a2gkgp">Events I've taken part in</h1> <h2 class="svelte-1a2gkgp">Dingle Animation Festival 2025</h2> <img id="dinglePhoto"${attr("src", `${stringify(base)}/dingle.png`)} alt="Two of my classmates and I at Dingle Animation Festival" class="svelte-1a2gkgp"> <p class="svelte-1a2gkgp">From March 20th - 22nd 2025, I had the pleasure of attending Dingle Animation Festival as a part of my course. During this event it was amazing to meet many lovely industry professionals, who offered their advice and I was able to gain many new Linkedin connections.
  ...
  $$payload.out += `<!----></div> <a${attr("href", `${stringify(base)}/liamcv.pdf`)} download="liamcv.pdf" aria-label="Download My CV"><span aria-hidden="true">⬇️</span> Download My CV</a></div>`;
  pop();
}
export {
  _page as default
